...
// TODO 03-Android传统异步请求复杂业务的痛点
class MainActivity3 : AppCompatActivity(){ // 本次代码：本次代码是告知大家，传统开发模式的痛点
            ...
            override fun responseSuccess(serverResponseInfo: String) {
                ...
                val handler : Handler = object : Handler(Looper.getMainLooper()) {
                    override fun handleMessage(msg: Message) {
                        ...
                        mainBinding.tvResult?.text = serverResponseInfo // 更新UI
                        mainBinding.tvResult?.setTextColor(Color.GREEN) // 更新UI
                            ...
                            override fun responseSuccess(serverResponseInfo: String) {
                                ...
                                val handler : Handler = object : Handler(Looper.getMainLooper()) {
                                    override fun handleMessage(msg: Message) {
                                        super.handleMessage(msg)
                                        mainBinding.tvResult?.text = serverResponseInfo // 更新UI
                                        mainBinding.tvResult?.setTextColor(Color.BLUE) // 更新UI
                                            ...
                                            override fun responseSuccess(serverResponseInfo: String) {
                                                ...
                                                val handler : Handler = object : Handler(Looper.getMainLooper()) {
                                                    override fun handleMessage(msg: Message) {
                                                        ...
                                                        mainBinding.tvResult?.setTextColor(Color.RED) // 更新UI
                                                    }
                                                }
